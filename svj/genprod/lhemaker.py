...
class LHEMaker(object):
    ...
    def __init__(self,
        ...
        self.seed = svj.genprod.SVJ_SEED if seed is None else seed
        self.model_name = svj.genprod.utils.get_model_name_from_tarball(tarball)
        self.process_type = self.get_process_type() if process_type is None else process_type

        self.run_gridpack_dir = svj.genprod.RUN_GRIDPACK_DIR
